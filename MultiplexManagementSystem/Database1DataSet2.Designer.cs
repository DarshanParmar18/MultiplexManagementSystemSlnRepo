...
namespace MultiplexManagementSystem {
    ...
    public partial class Database1DataSet2 : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmployeeRow AddEmployeeRow(string FirstName, string LastName, string Email, byte[] Image) {
...
namespace MultiplexManagementSystem.Database1DataSet2TableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Employee` WHERE ((`ID` = ?) AND ((? = 1 AND `FirstName` IS NULL) OR " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Employee` (`FirstName`, `LastName`, `Email`, `Image`) VALUES (?, ?, " +
                "?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Employee` SET `FirstName` = ?, `LastName` = ?, `Email` = ?, `Image` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `FirstName` IS NULL) OR (`FirstName` = ?)) AND ((? = 1 AND `LastName` IS NULL) OR (`LastName` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::MultiplexManagementSystem.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, FirstName, LastName, Email, [Image] FROM Employee";
        ...
        public virtual int Insert(string FirstName, string LastName, string Email, byte[] Image) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(string FirstName, string LastName, string Email, byte[] Image, int Original_ID, string Original_FirstName, string Original_LastName, string Original_Email) {
            if ((FirstName == null)) {
